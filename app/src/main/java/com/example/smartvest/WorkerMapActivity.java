...
public class WorkerMapActivity extends FragmentActivity implements OnMapReadyCallback {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( WorkerMapActivity.this, REQUIRED_PERMISSIONS,
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
               ...
               // Intent intent = new Intent(WorkerMapActivity.this, WelcomActivity.class);
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        String str_latitude = String.valueOf(location.getLatitude());
        String str_longitude = String.valueOf(location.getLongitude());
        ...
        WorkerlocationRequest workerlocationRequest = new WorkerlocationRequest(userID, str_datetime, str_latitude, str_longitude, responseListener);
        RequestQueue queue = Volley.newRequestQueue(WorkerMapActivity.this);
        queue.add(workerlocationRequest);
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(35.16, 126.85);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(WorkerMapActivity.this);
