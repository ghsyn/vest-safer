...
public class ManualNanganActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_nangan);
        ...
        String url = "file:///android_asset/manual_nangan.html";
        webView.loadUrl(url);
        /*
